...
const regex = /<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">\s*\{Array\.from[\s\S]*?Entri Sosiometri[\s\S]*?\}\)\}\)\}\s*<\/div>\s*\)\)\}\s*<\/div>/;

const correctCode = `<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
