                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-3 py-1.5 rounded-lg transition flex items-center gap-1.5 shadow-xs"
                      >
                              ...
                              <div>
                                <div className="flex justify-between items-start">
                                  ...
                                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button onClick={() => handleOpenManualForm(assessment)} className="p-1 text-slate-400 hover:text-indigo-600" title="Edit">
                                      <Edit3 className="w-3.5 h-3.5" />
                                    </button>
                                    <button onClick={() => { if(window.confirm('Hapus penilaian?')) onDeleteManualAssessment?.(assessment.id); }} className="p-1 text-slate-400 hover:text-rose-600" title="Hapus">
                                      <Trash2 className="w-3.5 h-3.5" />
                                    </button>
                                  </div>
                                </div>
                                <div className="flex flex-wrap gap-2 mt-1.5">
                                  <p className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded">{assessment.type}</p>
                                  <p className="text-[10px] font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">{getSubjectName(assessment.subjectId)}</p>
                                  <p className="text-[10px] font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">{assessment.date}</p>
                                </div>
                              </div>
                              <div className="flex justify-between items-center w-full mt-4 pt-3 border-t border-slate-100">
