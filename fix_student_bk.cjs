                    ...
                    <div className="p-6 border-t border-slate-100 flex justify-end gap-3 bg-slate-50">
                      ...
                      <button 
                        onClick={() => {
                          ...
                          alert('Sosiometri Berhasil Disimpan!');
                        }} 
...
// fix missing import Users
code = code.replace(
  "import { Play, CheckCircle, Clock, Search, BookOpen, AlertCircle, FileText, ChevronRight, X, AlertTriangle, Send } from 'lucide-react';",
  "import { Play, CheckCircle, Clock, Search, BookOpen, AlertCircle, FileText, ChevronRight, X, AlertTriangle, Send, Heart, MessageSquare, Users } from 'lucide-react';"
);
